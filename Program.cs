namespace sjdef
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Millist kujundit soovid? (Ruut, Ring, Ristkylik, Kolmnurk)");
            string valikud = Console.ReadLine().ToLower();
        ...
        {
            Console.WriteLine("Sisesta ringi raadius :D:");
        ...
        {
            Console.WriteLine("Sisesta ristkyliku laius:");
            ...
            Console.WriteLine($"Ristkyliku ümbermõõt on {umbermoot} ja pindala on {pindala} ühikut.");
        }

        static void KolmnurgaProgramm()
        {
            Console.WriteLine("Sisesta kolmnurga pikkus:");
            ...
            double kolmnurgaKorgus = Math.Sqrt(3) / 2 * alus; 
